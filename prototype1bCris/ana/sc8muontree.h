...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nHitsT1;
   Float_t         HitsT1Vx[MAXGENPAR];   //[nHitsR1]
   Float_t         HitsT1Vy[MAXGENPAR];   //[nHitsR1]
   Float_t         HitsT1Vz[MAXGENPAR];   //[nHitsR1]
   
   Int_t           nHitsT2;
   Float_t         HitsT2Vx[MAXGENPAR];   //[nHitsR1]
   Float_t         HitsT2Vy[MAXGENPAR];   //[nHitsR1]
   Float_t         HitsT2Vz[MAXGENPAR];   //[nHitsR1]
