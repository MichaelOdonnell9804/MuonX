...
class B4aEventAction : public G4UserEventAction
{
  public:
    ...
    void AddHitsTray(SC8Particle aSC8particle);
    void AddHitsTray2(SC8Particle aSC8particle);
  ...
  private:
    ...
    std::vector<SC8Particle>  vecSC8HitsTray;
    std::vector<SC8Particle>  vecSC8HitsTray2;
...
inline void B4aEventAction::AddHitsTray(SC8Particle aSC8Particle) {
	//     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1..."<<std::endl;
	//     //       std::cout<<"   size="<<vecSC8HitsRef1.size()<<std::endl;
	//     //       std::cout<<"   aSC8Particle... "<<aSC8Particle.pid<<std::endl;
      vecSC8HitsTray.push_back(aSC8Particle);
	//           //     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1   end..."<<std::endl;
	//           }
}

inline void B4aEventAction::AddHitsTray2(SC8Particle aSC8Particle) {
	//     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1..."<<std::endl;
	//     //       std::cout<<"   size="<<vecSC8HitsRef1.size()<<std::endl;
	//     //       std::cout<<"   aSC8Particle... "<<aSC8Particle.pid<<std::endl;
      vecSC8HitsTray2.push_back(aSC8Particle);
	//           //     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1   end..."<<std::endl;
	//           }
}
