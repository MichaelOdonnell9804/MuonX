...
//		std::cout<<"UserSteppingAction starting   before frist return "<<std::endl;
  ...
  FillTrayPlane(step,0);
  FillTrayPlane2(step,0);
...
//		std::cout<<"UserSteppingAction starting   rpdebug4e... "<<std::endl;
    ...
    if(thisName.compare(0,9,"TrayOne")==0)  {
//              std::cout<<"UserSteppingAction starting   rpdebug4c... "<<std::endl;
       FillTrayPlane(step,1);   // 1 Reference Plane 1
//              std::cout<<"UserSteppingAction starting   rpdebug4e... "<<std::endl;
     }
     if(thisName.compare(0,9,"TrayTwo")==0)  {
//              std::cout<<"UserSteppingAction starting   rpdebug4c... "<<std::endl;
       FillTrayPlane2(step,1);   // 1 Reference Plane 1
//              std::cout<<"UserSteppingAction starting   rpdebug4e... "<<std::endl;
     }
  }
...
//===============================================================================
void B4aSteppingAction::FillTrayPlane(const G4Step* step, int iflag) {
  //  iflag:  0 fill GenPar,  1 fill RefPlane
...
//  std::cout<<"rpdebug-A3a"<<std::endl;
     if(sc8part.pid==13 || sc8part.pid==-13) {
        // fill only muons...
//  std::cout<<"rpdebug-A3b"<<std::endl;
        fEventAction->AddHitsTray(sc8part);
//  std::cout<<"rpdebug-A3c"<<std::endl;
     }
  }
...
//===============================================================================
void B4aSteppingAction::FillTrayPlane2(const G4Step* step, int iflag) {
  //  iflag:  0 fill GenPar,  1 fill RefPlane
...
//  std::cout<<"rpdebug-A3a"<<std::endl;
     if(sc8part.pid==13 || sc8part.pid==-13) {
        // fill only muons...
//  std::cout<<"rpdebug-A3b"<<std::endl;
        fEventAction->AddHitsTray2(sc8part);
//  std::cout<<"rpdebug-A3c"<<std::endl;
     }
  }
