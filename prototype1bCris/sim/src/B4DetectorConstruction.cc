...
G4VPhysicalVolume* B4DetectorConstruction::DefineVolumes()
{
 ...
 // auto boxMaterial = G4Material::GetMaterial("tungsten");
  ...
  auto SC8SizeZ= 300.*cm; // a half width
...
/*
    ...
    //Sol
    //
    G4double SolX = 1000.0*cm;
    G4double SolY = 1000.0*cm;
    G4double SolZ = 300.0*cm;
    ...
    new G4PVPlacement(
            0,
            G4ThreeVector(0.0, 0.0, 700.0*cm ),
            SolLV,
            "Sol",
            worldLV,
            false,
...
*/
    ...
    // Lead Box
    //
    G4double BoxSizeX = 20.32*cm;
    G4double BoxSizeY = 10.16*cm;
    G4double BoxSizeZ = 5.08*cm;

    /*
    G4double TubeInnerRadius = 0*cm;
    G4double TubeOuterRadius = 150*cm;
    G4double TubeSizeZ = 50*cm;
    G4double TubePhi = 2.*M_PI*rad;
    
    auto PBconeS
       = new G4Tubs("PBbox",
               TubeInnerRadius, TubeOuterRadius, TubeSizeZ, 0., TubePhi);
   */

    auto PBboxS
        = new G4Box("PBbox", //its name
                BoxSizeX/2, BoxSizeY/2, BoxSizeZ/2);
    ...
    new G4PVPlacement(
            0,
            G4ThreeVector(0.0,0.0+BoxSizeY/2,TrayPosZ[0]+5*cm+1*cm+0*BoxSizeZ/2),
            PBboxLV,
            "PBbox",
            worldLV,
            false,
  ...
  TrayOneLV->SetVisAttributes(new G4VisAttributes(TRUE,G4Colour(0.345098, 0.407843, 0.121569, 0.30)));
  TrayTwoLV->SetVisAttributes(new G4VisAttributes(TRUE,G4Colour(0.345098, 0.407843, 0.121569, 0.30)));
