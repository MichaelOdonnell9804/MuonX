...
MuonTree::MuonTree(string macFileName,int argc,char** argv)
{
  ...
  for ( int i=1; i<argc; i=i+2 ) {
   ...
   histo1D["all_CryVx_wide"]=new TH1D("all_CryVx_wide","CRY- (all) X (meter) in CRY plane",1000,-100.0,0.0);
   histo1D["all_CryVy_wide"]=new TH1D("all_CryVy_wide","CRY- (all) Y (meter) in CRY plane",200,-10.0,10.0);
   histo1D["all_CryVz_wide"]=new TH1D("all_CryVz_wide","CRY- (all) Z (meter) in CRY plane",200,-10.0,10.0);
   ...
   histo1D["trig_CryVx_wide"]=new TH1D("trig_CryVx_wide","CRY- (trig) X (meter) in CRY plane",1000,-100.0,0.0);
   histo1D["trig_CryVy_wide"]=new TH1D("trig_CryVy_wide","CRY- (trig) Y (meter) in CRY plane",200,-10.0,10.0);
   histo1D["trig_CryVz_wide"]=new TH1D("trig_CryVz_wide","CRY- (trig) Z (meter) in CRY plane",200,-10.0,10.0);
   ...
   histo1D["cairnEdp"]=new TH1D("cairnEdep","cairn Edep (GeV)",1000,0.,20.0);
   histo1D["cairnStep"]=new TH1D("cairnStep","cairn Step: (m)", 100,0.,50.0);
   histo1D["cairnEdpTrig"]=new TH1D("cairnEdepTrig","(trig) cairn Edep (GeV)",1000,0.,20.0);
   histo1D["cairnStepTrig"]=new TH1D("cairnStepTrig","(trig) cairn Step: (m)", 100,0.,50.0);

   histo1D["chamberEdp"]=new TH1D("chamberEdep","chamber Edep (GeV)",1000,0.,5.0);
   histo1D["chamberStep"]=new TH1D("chamberStep","chamber Step: (m)", 100,0.,5.0);
   histo1D["chamberEdpTrig"]=new TH1D("chamberEdepTrig","(trig) chamber Edep (GeV)",1000,0.,5.0);
   histo1D["chamberStepTrig"]=new TH1D("chamberStepTrig","(trig) chamber Step: (m)", 100,0.,5.0);

   histo1D["passageEdp"]=new TH1D("passageEdep","passage Edep (GeV)",1000,0.,5.0);
   histo1D["passageStep"]=new TH1D("passageStep","passage Step: (m)", 100,0.,5.0);
   histo1D["passageEdpTrig"]=new TH1D("passageEdepTrig","(trig) passage Edep (GeV)",1000,0.,5.0);
   histo1D["passageStepTrig"]=new TH1D("passageStepTrig","(trig) passage Step: (m)", 100,0.,5.0);

   histo1D["RefX"]=new TH1D("RefX","Ref X (m) ",1000,-100.0,0.0);
   histo1D["RefY"]=new TH1D("RefY","Ref Y (m) ",200, -5.0,5.0);
   histo1D["RefZ"]=new TH1D("RefZ","Ref Z (m) ",600, -15.0,15.0);
   histo1D["RefP"]=new TH1D("RefP","Ref P (GeV) ",1000, 0.0, 100.0);
   histo1D["RefYtrig"]=new TH1D("RefYtrig","(trig) Ref Y (m) ",200, -5.0,5.0);
   histo1D["RefZtrig"]=new TH1D("RefZtrig","(trig) Ref Z (m) ",600, -15.0,15.0);
   
   histo2D["RefYZ"]=new TH2D("RefYZ","Ref Y-Z",100,-5.0,5.0,300,-15.0,15.0);
   histo2D["RefYZtrig"]=new TH2D("RefYZtrig","Ref Y-Z",100,-5.0,5.0,300,-15.0,15.0);

   histo1D["ProjY"]=new TH1D("ProjY","Muon- Porjected Y (in m at X=0)",100,-25.0,25.0);
   histo1D["ProjZ"]=new TH1D("ProjZ","Muon- Porjected Z (in m at X=0)",50,-5.0 ,20.0);
   histo1D["ProjZ1"]=new TH1D("ProjZ1","Muon- Porjected Z y=[-6,-2 (in m at X=0)",50,-5.0 ,20.0);
   histo1D["ProjZ2"]=new TH1D("ProjZ2","Muon- Porjected Z y=[-2,+2](in m at X=0)",50,-5.0 ,20.0);
   histo1D["ProjZ3"]=new TH1D("ProjZ3","Muon- Porjected Z y=[+2,+4](in m at X=0)",50,-5.0 ,20.0);
   histo2D["ProjYZ"]=new TH2D("ProjYZ","Muon- Porjected Y-Z (in m at X=0)",20,-10.,10.,16,0.0,8.);
   histo2D["ProjYZ2"]=new TH2D("ProjYZ2","Muon- Porjected Y-Z (in m at X=0)",100,-10.,10.,100,-1.0,19.0);
   histo2D["ProjYZ2trig"]=new TH2D("ProjYZ2trig","Muon (trig)- Porjected Y-Z (in m at X=0)",100,-10.,10.,100,-1.0,19.0);
...
void MuonTree::analyze(){
  ...
  for(int i=0; i<mnCry[0]; i++){
     ...
     if(mCryPid[i]==13 || mCryPid[i]==-13) {
        ...
        histo1D["all_CryVx_wide"]->Fill(mCryVx[i]);
        histo1D["all_CryVy_wide"]->Fill(mCryVy[i]);
        histo1D["all_CryVz_wide"]->Fill(mCryVz[i]);
        if(trig) {
           ...
           histo1D["trig_CryVx_wide"]->Fill(mCryVx[i]);
           histo1D["trig_CryVy_wide"]->Fill(mCryVy[i]);
           histo1D["trig_CryVz_wide"]->Fill(mCryVz[i]);
        }
     }
  }
  ...
  for(int i=0; i<mnGen[0]; i++){
     ...
     double ylimitPlus=getParamF("chamberSizeY")/2.0;
     double ylimitMinus=-ylimitPlus;
     for(unsigned it=0; it<mRefProjVy.size(); it++) {
        histo1D["RefX"]->Fill(mRefVx[it]);
        histo1D["RefY"]->Fill(mRefVy[it]);
        histo1D["RefZ"]->Fill(mRefVz[it]);
        histo1D["RefP"]->Fill(mRefP[it]);
        histo2D["RefYZ"]->Fill(mRefVy[it],mRefVz[it]);

        histo1D["ProjY"]->Fill(mRefProjVy[it]);
        histo1D["ProjZ"]->Fill(mRefProjVz[it]);
        histo2D["ProjYZ"]->Fill(mRefProjVy[it],mRefProjVz[it]);
        histo2D["ProjYZ2"]->Fill(mRefProjVy[it],mRefProjVz[it]);
        if(trig) {
           histo2D["ProjYZ2trig"]->Fill(mRefProjVy[it],mRefProjVz[it]);
           histo2D["RefYZtrig"]->Fill(mRefVy[it],mRefVz[it]);
           histo1D["RefYtrig"]->Fill(mRefVy[it]);
           histo1D["RefZtrig"]->Fill(mRefVz[it]);  
      }
        if(mRefProjVy[it]>-6.0 && mRefProjVy[it]<-2.0) histo1D["ProjZ1"]->Fill(mRefProjVz[it]);
        // if(mRefProjVy[it]>-2.0 && mRefProjVy[it]<2.0) histo1D["ProjZ2"]->Fill(mRefProjVz[it]);
        if(mRefProjVy[it]>ylimitMinus && mRefProjVy[it]<ylimitPlus) histo1D["ProjZ2"]->Fill(mRefProjVz[it]);
        if(mRefProjVy[it]>2.0  && mRefProjVy[it]<6.0) histo1D["ProjZ3"]->Fill(mRefProjVz[it]);
     }

     //
     for(unsigned it=0; it<mCairnEdep.size(); it++) {
         histo1D["cairnEdp"]->Fill(mCairnEdep[it]/GeV);
         histo1D["cairnStep"]->Fill(mCairnStep[it]/m);
         if(trig) {
             histo1D["cairnEdpTrig"]->Fill(mCairnEdep[it]/GeV);
             histo1D["cairnStepTrig"]->Fill(mCairnStep[it]/m);
         }
     }
 
     //
     for(unsigned it=0; it<mChamberEdep.size(); it++) {
         histo1D["chamberEdp"]->Fill(mChamberEdep[it]/GeV);
         histo1D["chamberStep"]->Fill(mChamberStep[it]/m);
         if(trig) {
             histo1D["chamberEdpTrig"]->Fill(mChamberEdep[it]/GeV);
             histo1D["chamberStepTrig"]->Fill(mChamberStep[it]/m);
         }
     }
 
     //
     for(unsigned it=0; it<mPassageEdep.size(); it++) {
         histo1D["passageEdp"]->Fill(mPassageEdep[it]/GeV);
         histo1D["passageStep"]->Fill(mPassageStep[it]/m);
         if(trig) {
             histo1D["passageEdpTrig"]->Fill(mPassageEdep[it]/GeV);
             histo1D["passageStepTrig"]->Fill(mPassageStep[it]/m);
         }
     }
...
void MuonTree::addRefParticle(SC8Particle aParticle) {
     ...
     double dx=abs(aParticle.x);
     mRefProjVx.push_back(0.0);
     mRefProjVy.push_back(dx*aParticle.py/aParticle.px+aParticle.y);
     mRefProjVz.push_back(dx*aParticle.pz/aParticle.px+aParticle.z);
