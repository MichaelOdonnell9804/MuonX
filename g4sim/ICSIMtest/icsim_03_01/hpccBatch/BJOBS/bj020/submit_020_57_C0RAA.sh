...
${exefile} -b ${macfile} -numberOfEvents 1000000 -runNumber 020 -runSeq 57 -createNtuple false -chamberSizeX 3.0 -chamberSizeY 3.0 -chamberSizeZ 3.0 -passagePosY 6.5
