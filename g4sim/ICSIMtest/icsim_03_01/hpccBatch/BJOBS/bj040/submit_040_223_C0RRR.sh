...
${exefile} -b ${macfile} -numberOfEvents 5000000 -runNumber 040 -runSeq 223 -createNtuple false -chamberSizeX 4.0 -chamberSizeY 4.0 -chamberSizeZ 3.0 -passagePosY 7.0
