...
${exefile} -b ${macfile} -numberOfEvents 5000000 -runNumber 042 -runSeq 217 -createNtuple false -chamberSizeX 4.0 -chamberSizeY 4.0 -chamberSizeZ 3.0 -passagePosY 7.0 -cameraWidth 8.0
