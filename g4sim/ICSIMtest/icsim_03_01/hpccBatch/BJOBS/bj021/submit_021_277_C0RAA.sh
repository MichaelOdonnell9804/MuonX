...
${exefile} -b ${macfile} -numberOfEvents 2000000 -runNumber 021 -runSeq 277 -createNtuple false -chamberSizeX 3.0 -chamberSizeY 3.0 -chamberSizeZ 3.0 -passagePosY 6.5
