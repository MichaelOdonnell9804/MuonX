...
macfile="/home/skunori/MuonX/g4sim/ICSIMtest/icsim_02_02/hpccBatch/macfiles/v02/batch_run_XXXXMAC_01.mac"
jobdir="XXXXJOBDIR/ROOTFILES"
...
${exefile} -b ${macfile} -numberOfEvents XXXXEVENTS -runNumber XXXXRUN -runSeq XXXXSEQ -createNtuple false -chamberSizeX 4.0 -chamberSizeY 4.0 -chamberSizeZ 4.0 -passagePosY 12.0
