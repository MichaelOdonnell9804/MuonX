...
${exefile} -b ${macfile} -numberOfEvents 2000000 -runNumber 014 -runSeq 18 -createNtuple false -chamberSizeX 2.0 -chamberSizeY 2.0 -chamberSizeZ 2.0 -passagePosY 11.0
