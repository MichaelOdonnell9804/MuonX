...
macfile="/home/skunori/MuonX/g4sim/ICSIMtest/icsim_02_02/hpccBatch/macfiles/v02/batch_run_C1RAA_01.mac"
...
${exefile} -b ${macfile} -numberOfEvents 2000000 -runNumber 014 -runSeq 180 -createNtuple false -chamberSizeX 2.0 -chamberSizeY 2.0 -chamberSizeZ 2.0 -passagePosY 11.0
