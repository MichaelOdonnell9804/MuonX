...
${exefile} -b ${macfile} -numberOfEvents 2000000 -runNumber 013 -runSeq 97 -createNtuple false -chamberSizeX 2.0 -chamberSizeY 2.0 -chamberSizeZ 2.0 -passagePosY 11.0
