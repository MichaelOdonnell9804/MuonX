...
${exefile} -b ${macfile} -numberOfEvents 2000000 -runNumber 015 -runSeq 70 -createNtuple false -chamberSizeX 3.0 -chamberSizeY 3.0 -chamberSizeZ 3.0 -passagePosY 11.5
