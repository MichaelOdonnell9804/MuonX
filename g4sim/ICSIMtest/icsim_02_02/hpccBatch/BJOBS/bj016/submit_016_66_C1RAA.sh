...
${exefile} -b ${macfile} -numberOfEvents 2000000 -runNumber 016 -runSeq 66 -createNtuple false -chamberSizeX 4.0 -chamberSizeY 4.0 -chamberSizeZ 4.0 -passagePosY 12.0
