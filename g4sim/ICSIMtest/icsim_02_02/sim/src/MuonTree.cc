...
void MuonTree::EndJob() {
  ...
  // -sk- std::chrono::steady_clock::time_point endTime=std::chrono::steady_clock::now();
  // -sk- std::chrono::duration<double> time_span=duration_cast<std::chrono::duration<double>>(endTime-startTimeJob);
  // -sk- std::cout<<"Duration of this job: "<<time_span.count()<<" seconds"<<std::endl;
  //
  // -sk- std::cout<<"Total time for PrimaryGeneratorAction: "<<totalTimePGA.count()<<" seconds"<<std::endl;
  // -sk- std::cout<<"Total time for TimeB4aEventAction:   : "<<totalTimeEVT.count()<<" seconds"<<std::endl;
...
void MuonTree::endTimePrimaryGeneratorAction() {
   ...
   // std::chrono::duration<double> time_span=duration_cast<std::chrono::duration<double>>(endTime-startTimePGA);
...
void MuonTree::endTimeB4aEventAction() {
   // std::chrono::steady_clock::time_point endTime=std::chrono::steady_clock::now();
   // std::chrono::duration<double> time_span=duration_cast<std::chrono::duration<double>>(endTime-startTimeEVT);
